...
from src.MLPROJECT_2.utils import save_object, evaluate_models
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # MLflow Integration
            # -------------------------------
            mlflow.set_registry_uri("https://dagshub.com/ansh21563/mlproject_2.mlflow")
            ...
            with mlflow.start_run(run_name="model_training"):
                ...
                if best_params:  # log only if params dict is not empty
